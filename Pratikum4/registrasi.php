...
$domisili = ['Jakarta', 'Depok', 'Bogor', 'Tanggerang', 'Bekasi', 'lainya'];
...
<fieldset class="mx-5 border p-4 mt-5">
        ...
        <form method="POST" action="proses_registrasi.php">
            ...
            <div class="form-group row">
                <label class="col-4">Skil Web &amp; Programing</label>
                <div class="col-8">
                    <?php foreach ($skills as $key => $value) : ?>
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input name="skills[]" id="skill_<?php echo $key?>" type="checkbox" class="custom-control-input" value="<?php echo $key?>">
                            <label for="skill_<?php echo $key?>" class="custom-control-label"><?php echo $key?></label>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
